...
sleep.dropna(thresh=9, axis=0, inplace=False).shape #list out those data which have got at least 9 non NA values
sleep.dropna(thresh=55, axis=1, inplace=False).shape #list out those rows which have at least 55 non NA values
